  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 min-h-[90dvh]">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
              {[
                ...
                <div key={index} className="relative group h-full">
                  <ScrollAppear delay={0.4 + 0.15*index} duration={0.8} className="h-full">
                  <div className="flex flex-col items-center space-y-4 rounded-xl border bg-card p-6 shadow-sm transition-all hover:shadow-md h-full">
                    {feature.icon}
        ...
        <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 m-auto">
            ...
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3">
              {[
                ...
                <div key={index} className="relative">
                  <ScrollAppear delay={0.6+0.75*index} yOffset={80} duration={1}>
                    <div className="flex flex-col space-y-4 rounded-xl border bg-radial-[at_0_0] to-80% from-muted/40 to-transparent p-6 shadow-sm h-full">
                      <div className={`text-4xl font-bold text-foreground/70 animate-pulse delay-${
                        index === 0 ? '' :
                        index === 1 ? '500' :
                        '1000'
                      }`}>{step.step}</div>
            ...
            <div className="flex justify-center mt-8">
              <ScrollAppear delay={1.5} yOffset={75}>
                <Link href="/signup">
                  <Button>
                    Try It Now
        ...
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 m-auto">
            ...
            <div className="mx-auto grid max-w-5xl gap-6 py-12 sm:w-80 lg:grid-cols-3 lg:w-auto">
              {[
                {
                  name: "Free",
                  price: "$0",
      ...
      <footer className="w-full border-t py-6 bg-background">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row px-4 md:px-6 m-auto">
          ...
          <ModeToggle/>
            <span className="text-lg font-bold ml-2">Notate</span>
          </div>
