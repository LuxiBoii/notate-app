  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background to-muted/20">
      <div className="w-full max-w-md">
        <Card className="border-muted/75 shadow-lg">
                ...
                <div className="flex justify-center w-full mt-2">
                  <Link href="/">
                    <Image
                        ...
                        width={26}
                        height={26}
                        className="hidden dark:flex size-8"
                    />
                    <Image
                        src="/favicon.png"
                        alt="Logo"
                        width={26}
                        height={26}
                        className="flex dark:hidden size-8"
                    />
                  </Link>
                </div>
            </div>
              ...
              <div className="grid gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="username" type="text" placeholder="john_doe" className="pl-7" minLength={1} maxLength={30} pattern="[a-z0-9]([a-z0-9]|-(?!_)|_(?!-))*[a-z0-9]"  title="2-30 letters. Only lowercase letters, numbers, '-' and '_'" required />
                  </div>
                </div>
                <div className="space-y-2">
